    ...
    <SiteLayout>
      <Head title="PETROPLAY">
        <meta
          ...
          name="description"
          content="Acesse o PetroPlay, a plataforma exclusiva da Petroplus com treinamentos, materiais informativos e soluções focadas no mercado automotivo."
        />
      </Head>
      ...
      <div className="hidden md:block">
        <section className="relative overflow-hidden bg-white py-16">
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true, amount: 0.2 }}
            className="mx-auto flex w-[90%] items-start gap-12"
          >
            <motion.div
              variants={fadeRightVariant}
            ...
            >
              ...
              <h2 className="mb-8 text-2xl font-bold uppercase leading-snug text-petroplus-orange">
                O PETROPLAY VAI ALÉM DE UM SIMPLES CHECKLIST <br />
                DIGITAL, É{' '}
                <span className="relative whitespace-nowrap">
                  UMA OFICINA DIGITAL COMPLETA
                  <span className="absolute -bottom-1 left-0 z-0 h-[1px] w-[600px] bg-petroplus-orange" />
                </span>
              </h2>

              <ul className="flex flex-col gap-4 text-xl leading-relaxed text-petroplus-gray-700">
            ...
            <motion.div variants={fadeLeftVariant} className="w-1/2">
              <div className="relative z-10 rounded-xl border border-petroplus-orange bg-white p-10 shadow-sm">
                <h3 className="mb-4 text-2xl font-bold uppercase text-petroplus-orange">
                  QUADRO PRODUTIVO GRATUITO
                </h3>
                <p className="mb-6 text-xl leading-relaxed text-petroplus-gray-700">
                  Monitore em{' '}
                  <strong className="font-bold text-petroplus-orange">
                    tempo real a produtividade da sua equipe
                  </strong>{' '}
                  e identifique gargalos com facilidade.
                </p>
                <p className="text-xl leading-relaxed text-petroplus-gray-700">
                  Mais{' '}
                  <strong className="font-bold text-petroplus-orange">
                    controle, agilidade nas entregas e zero custo adicional
                  </strong>{' '}
      ...
      <div className="hidden md:block">
        <section
          className="overflow-hidden bg-cover bg-center bg-no-repeat py-12 md:py-16"
          style={{ backgroundImage: 'url("/illust/petroplay.png")' }}
        >
          <motion.div
            variants={fadeUpVariant}
            initial="hidden"
            ...
            className="mx-auto flex w-[80%] flex-col gap-4"
          >
            <div className="grid grid-cols-2 items-center divide-x-2 divide-white">
              <div className="pr-5 text-left lg:text-right">
                <p className="text-[10px] leading-relaxed font-bold text-white lg:text-xl lg:leading-relaxed">
                  DIGITALIZE SUA CONCESSIONÁRIA E TRANSFORME O PÓS-VENDA
                </p>
              </div>

              <div className="pl-5 text-left">
                <p className="text-[10px] leading-relaxed text-white lg:text-xl lg:leading-relaxed">
                  Conte com uma solução completa e integrada para elevar a
                  eficiência e a satisfação do cliente.
                </p>
              </div>
