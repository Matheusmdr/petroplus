  ...
  return (
    <>
      ...
      <main id="public-main-content">
        ...
        <section className='animate-gradient flex w-full flex-col items-center bg-gradient-to-r from-petroplus-orange via-[#FD5B1D] to-petroplus-orange bg-[length:200%_auto]'>
