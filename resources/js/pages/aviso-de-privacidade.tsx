    ...
    <SiteLayout>
      <Head title="Aviso de Privacidade">
        <meta
          ...
          name="description"
          content="Aviso de Privacidade da Petroplus. Saiba como coletamos e tratamos seus dados pessoais em conformidade com as leis vigentes."
        />
      </Head>
      <section className="relative flex flex-col items-center justify-center">
        ...
        >
          <h1 className="text-center text-xl font-bold text-white uppercase lg:text-5xl">
            Aviso de
            <br className="md:hidden" /> Privacidade
          </h1>
        </motion.div>
      </section>
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <p className="text-lg font-bold text-[#182951]">
                I. COMPROMISSO DA PETROPLUS COM A PRIVACIDADE E PROTEÇÃO DE
                DADOS PESSOAIS
              </p>
              <p className="text-justify leading-relaxed">
                A PETROPLUS SUL COMÉRCIO EXTERIOR LTDA. (“PETROPLUS”) considera
                a privacidade e a proteção de dados do USUÁRIO e/ou VISITANTE
              ...
              <p className="text-justify leading-relaxed">
                ...
                PRIVACIDADE, a fim de informar claramente ao USUÁRIO do SITE
                e/ou APLICATIVO, de que modo são tratados dados pessoais por
                estes fornecidos quando do acesso ao SITE e/ou utilização de
            ...
            <div className="space-y-4">
              ...
              <p className="text-justify leading-relaxed">
                ...
                através das disposições contidas na Lei Geral de Proteção de
                Dados – Lei 13.709/2018 (“LGPD”), na Lei nº 8.078/90 (“Código de
                Defesa do Consumidor”) quando o uso dos dados decorrer de
                relações de consumo, na Lei nº 12.965/14 (“Marco Civil da
                Internet”), bem como na Constituição Federal da República
                Federativa do Brasil de 1988 (“Constituição Federal”).
              </p>
              <p className="text-justify leading-relaxed">
                ...
                relação a todo e quaisquer dados pessoais que utilizar no âmbito
                e em razão de suas atividades.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-justify leading-relaxed">
                ...
                identifiquem ou permitam a identificação de uma determinada
                pessoa natural.
              </p>
              <p className="text-justify leading-relaxed">
                A LGPD ainda define ‘dados pessoais sensíveis’ como sendo
                aqueles sobre origem racial ou étnica, convicção religiosa,
            ...
            <div className="space-y-4">
                ...
                <table className="min-w-full border-collapse border border-gray-300 text-sm">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 p-4 text-justify align-top text-[#182951]">
                        Para esta finalidade, os dados são fornecidos pelo
                        USUÁRIO através do cadastramento prévio pela PETROPLUS
                        ao sistema.
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-gray-300 p-4 text-justify align-top text-[#182951]">
                        Entrar em contato com a PETROPLUS sobre possíveis
                        dúvidas
                      </td>
                      <td className="border border-gray-300 p-4 text-justify align-top text-[#182951]">
                        Para esta finalidade, os dados são fornecidos
              ...
              <p className="border-l-4 border-[#182951] bg-gray-50 p-4 text-justify leading-relaxed">
                ...
                armazenamento ou utilização dos dados pessoais do USUÁRIO de
                forma diversa ou para outros fins que não aqueles explicitados
                mais adiante neste Aviso de Privacidade.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-justify leading-relaxed">
                A utilização de dados pessoais de crianças e/ou adolescentes
                será realizada no melhor interesse dos mesmos em conformidade
                com o disposto na LGPD, mediante o consentimento específico e em
                destaque dado por pelo menos um dos pais ou responsável legal,
                exceto nos casos em que os dados do menor sejam utilizados para
                o contato da PETROPLUS com os pais ou responsável legal ou para
                sua proteção, sendo que em nenhum caso serão repassados a
                terceiros.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-justify leading-relaxed">
                ...
                informações que são descarregados para o seu dispositivo por
                meio de sites, aplicativos, mídias digitais e anúncios. Os
                cookies são úteis porque permitem que um site reconheça o
                dispositivo de um usuário quando ele acessar determinada página
                novamente.
              </p>
              <p className="text-justify leading-relaxed">
                Os cookies poderão guardar, de forma duradoura, um arquivo no
                seu computador. Este arquivo poderá ser utilizado para
                personalizar nosso site com base nas suas escolhas e interesses
                de navegações anteriores.
              </p>
              ...
              <ul className="list-disc space-y-2 pl-6 text-justify">
                <li>
                  <strong>Cookies Necessários:</strong> são os cookies
                  necessários para que o SITE trabalhe normalmente.
                </li>
                <li>
              ...
              <p className="text-justify leading-relaxed">
                ...
                quantidade mínima de cookies corresponde aos cookies
                necessários, exceto se houver alterado as configurações de seu
                navegador a fim de informar ou bloquear automaticamente o
                armazenamento de cookies no seu dispositivo de acesso.
              </p>
              <p className="text-justify leading-relaxed">
              ...
              <p className="text-justify leading-relaxed">
                ...
                preferências, sendo certo que os Cookies Necessários serão
                sempre obrigatórios para o funcionamento do SITE e/ou
                APLICATIVO. Caso opte por aceitar todos os cookies utilizados no
                SITE e/ou APLICATIVO, bastará ao USUÁRIO clicar no botão
                “ACEITO”.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-justify leading-relaxed">
                ...
                pelo período necessário ao tratamento de dados, ressalvado o
                caso de revogação do consentimento do titular, conforme direitos
                do USUÁRIO posteriormente especificados, ou ainda por
              ...
              <p className="text-justify leading-relaxed">
                ...
                proteção e privacidade dos seus dados pessoais, contra acessos
                não autorizados, situações acidentais ou ilícitas de destruição,
                perda, alteração, comunicação ou qualquer forma de tratamento
                inadequado ou ilícito.
              </p>
              <p className="text-justify leading-relaxed">
                Além disso, a PETROPLUS poderá conservar os dados e/ou
                informações pessoais dos USUÁRIOS para: (a) cumprimento de
                obrigação legal ou regulatória; (b) transferência a terceiro,
                desde que observados eventuais requisitos de tratamento de dados
                estabelecidos pela legislação aplicável; (c) uso exclusivo do
                controlador, vedado seu acesso por terceiro, e desde que
                anonimizados os dados; (d) outras hipóteses previstas na
                legislação aplicável, conforme o caso.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-justify leading-relaxed">
                ...
                de serviço, para fins exclusivos de prover os serviços
                oferecidos pela PETROPLUS com qualidade.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc space-y-2 pl-6 text-justify">
                <li>
                  Confirmação quanto a existência de tratamento de dados
                  pessoais de sua exclusiva titularidade, que estejam sob a
                  posse e/ou forem tratados pela PETROPLUS;
                </li>
                <li>
                  Acesso aos dados pessoais, mediante a emissão de um extrato
                  contendo todos os dados pessoais tratados pela PETROPLUS, que
                  será enviado para o e-mail registrado nos sistemas ou ainda,
                  em formato impresso, se assim o preferir, em nosso endereço
                  administrativo;
                </li>
                <li>
                ...
                <li>
                  ...
                  desnecessários, excessivos e/ou tratados em desconformidade
                  com o disposto no presente AVISO DE PRIVACIDADE e/ou na
                  legislação vigente. O USUÁRIO poderá, ainda, solicitar a
                  eliminação de dados pessoais tratados mediante seu
                  consentimento;
                </li>
                <li>
                  Portabilidade dos dados pessoais, para outro fornecedor de
                  produtos e/ou serviços, conforme a regulamentação de tal
                  direito pela Autoridade Nacional de Proteção de Dados e
                  observados os eventuais segredos comerciais da PETROPLUS;
                </li>
                <li>
              ...
              <p className="mt-4 text-justify leading-relaxed">
                O USUÁRIO poderá exercer quaisquer dos seus direitos
                estabelecidos acima e/ou na legislação vigente, mediante
                manifestação e/ou solicitação através do e-mail:{' '}
                <a
              ...
              <p className="text-justify leading-relaxed">
                A PETROPLUS informa que o presente AVISO DE PRIVACIDADE poderá
                ser alterado a qualquer momento, conforme novidades legislativas
                e/ou mudanças de suas atividades, sendo certo que na ocorrência
                desta hipótese, os USUÁRIOS do SITE e/ou APLICATIVO serão
                devidamente e previamente comunicados.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-justify leading-relaxed">
                Em quaisquer casos de dúvidas e/ou informações adicionais sobre
                o tratamento dos dados pessoais pela PETROPLUS e/ou disposições
                contidas neste AVISO DE PRIVACIDADE, entre em contato através
                dos canais abaixo:
              </p>
