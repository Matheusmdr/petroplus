...
* @see app/Http/Controllers/Admin/BrandController.php:15
* @route '/admin/brands'
*/
...
* @see app/Http/Controllers/Admin/BrandController.php:31
* @route '/admin/brands'
*/
...
* @see app/Http/Controllers/Admin/BrandController.php:0
...
* @see app/Http/Controllers/Admin/BrandController.php:92
* @route '/admin/brands/{brand}'
*/
